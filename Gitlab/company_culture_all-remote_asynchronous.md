...
If someone is [traveling](/handbook/company/culture/all-remote/) to a new time zone each month, or chooses to spend a beautiful afternoon [with family](/handbook/company/culture/all-remote/), that's their [prerogative](https://about.gitlab.com/blog/2019/12/10/how-to-build-a-more-productive-remote-team/).
...
To further optimize this approach, consider adding a "[flexible time off policy](/handbook/people-group/time-off-and-absence/time-off-types/)", which means team members do not need to ask permission to step away from work.

All-remote settings empower team members to [live and work where they're most fulfilled](/handbook/company/culture/all-remote/). Increasingly, operating asynchronously is necessary even in colocated companies which have team members on various floors or offices, especially when multiple time zones are involved.
...
At GitLab ([the company](/handbook/company/)), that destination is GitLab ([the product](https://about.gitlab.com/stages-devops-lifecycle/)). Any side conversation that occurs in a meeting is [documented](/handbook/communication/#internal-communication) in an agenda, and the useful elements are [contextualized](/handbook/company/culture/all-remote/) and ported to relevant GitLab issues and/or merge requests. The same goes for side conversations that happen in Slack or email. Relevant portions are ported over into GitLab (the product), which is the [single source of truth](/handbook/values/#single-source-of-truth) for any ongoing work.
...
This is an extension of another remote-first forcing function: [Always answer with a link](/handbook/company/culture/all-remote/).
...
While GitLab's approach to [self-service and self-learning](/handbook/company/culture/all-remote/) is reinforced during onboarding, continual reinforcement may be necessary. It is acceptable to ask someone if they are exercising a bias towards asynchronous communication, regardless of their position on the org chart.
...
The organizer is responsible for informing the entire company, via post-meeting documentation, of the outcomes should team members [go searching](/handbook/company/culture/all-remote/). That's a big responsibility, which keeps the quantity of meetings in check and acts as a filter for whether or not a meeting is truly necessary.
...
| **Broadening coverage during PTO**                           | Team members may assign a `Channel` instead of a `Co-worker` to cover for them when planning [paid time off](/handbook/people-group/time-off-and-absence/time-off-types/) using Time Off by Deel. |
...
| **Missed deliverable retrospective**                         | [Engineering Package Group](/handbook/engineering/devops/package/) utilizes async deliverable retrospectives through GitLab issues labeled `~"group::package"` |
...
Teams should embrace a [self-service mentality](/handbook/company/culture/all-remote/), [single source of truth (SSoT)](/handbook/values/#single-source-of-truth) to fully understand the capabilities of asynchronous workflows, how GitLab (the product) [facilitates asynchronous communication](https://about.gitlab.com/blog/2019/08/02/gitlab-for-the-non-technical/), and how to leverage [existing tools](/handbook/tools-and-tips) (e.g. Google Docs) in an asynchronous manner.
